...
[root@localhost ~]# mysql --user=root --password=pw --execute="CREATE USER 'icatuser'@'localhost' IDENTIFIED BY 'icatpw';"
[root@localhost ~]# mysql --user=root --password=pw --execute="GRANT ALL PRIVILEGES ON *.* TO 'icatuser'@'localhost';"
```
